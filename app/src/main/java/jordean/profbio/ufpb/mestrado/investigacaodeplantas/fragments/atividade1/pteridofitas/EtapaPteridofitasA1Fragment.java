 ...
 */
public class EtapaPteridofitasA1Fragment extends TelaFotoFragment {

    private ImageView imagemSoros;
    private FotoIdentificacaoModel fotoIdentificacaoModel;

    public EtapaPteridofitasA1Fragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fotoIdentificacaoModel.setFotoSoros(null);

        imagemSoros = view.findViewById(R.id.image_soros);

        imagemSoros.setOnClickListener(v -> openCamera(CAMERA_ACTION_PICK_REQUEST_CODE_1));

        Button proxima = view.findViewById(R.id.button_next3a1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_etapa_pteridofitas_a1, container, false);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode == CAMERA_ACTION_PICK_REQUEST_CODE_1 && resultCode == RESULT_OK && data != null) {
            ...
            fotoIdentificacaoModel.setFotoSoros(imagePath);
            loadImage(imagePath, imagemSoros);
